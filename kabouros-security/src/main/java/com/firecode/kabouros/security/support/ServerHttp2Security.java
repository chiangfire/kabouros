package com.firecode.kabouros.security.support;
 ...
 * 
 * public FormLoginSpec authenticationConverter(Function<ServerWebExchange, Mono<Authentication>> authenticationConverter) {
 *     this.authenticationConverter = authenticationConverter;
 *	   return this;
 * }
 *
 * authenticationFilter.setAuthenticationConverter(this.authenticationConverter);
 * 
 * @author Rob Winch
 * @author jiang
 * @since 5.0
 */
public class ServerHttp2Security {
	 ...
	 */
	public ServerHttp2Security securityMatcher(ServerWebExchangeMatcher matcher) {
		Assert.notNull(matcher, "matcher cannot be null");
		this.securityMatcher = matcher;
		return this;
	}

	public ServerHttp2Security addFilterAt(WebFilter webFilter, SecurityWebFiltersOrder order) {
	...
	public ServerHttp2Security securityContextRepository(ServerSecurityContextRepository securityContextRepository) {
	...
	public ServerHttp2Security authenticationManager(ReactiveAuthenticationManager manager) {
	...
	public static ServerHttp2Security http() {
		return new ServerHttp2Security();
	}
	...
	public class AuthorizeExchangeSpec
		...
		public ServerHttp2Security and() {
			return ServerHttp2Security.this;
		}
		...
		protected void configure(ServerHttp2Security http) {
			if(this.matcher != null) {
	...
	public class CsrfSpec {
		...
		public ServerHttp2Security disable() {
			ServerHttp2Security.this.csrf = null;
			return ServerHttp2Security.this;
		}
	...
	public class ExceptionHandlingSpec {
		...
		public ExceptionHandlingSpec authenticationEntryPoint(ServerAuthenticationEntryPoint authenticationEntryPoint) {
			ServerHttp2Security.this.authenticationEntryPoint = authenticationEntryPoint;
			return this;
		}
	...
	public class HttpBasicSpec {
		...
		public ServerHttp2Security disable() {
			ServerHttp2Security.this.httpBasic = null;
			return ServerHttp2Security.this;
		}
		...
		protected void configure(ServerHttp2Security http) {
			...
			ServerHttp2Security.this.defaultEntryPoints.add(new DelegateEntry(restMatcher, this.entryPoint));
	...
	public class FormLoginSpec {
		...
		public ServerHttp2Security disable() {
			ServerHttp2Security.this.formLogin = null;
			return ServerHttp2Security.this;
		}
		...
		protected void configure(ServerHttp2Security http) {
			...
			ServerHttp2Security.this.defaultEntryPoints.add(0, new DelegateEntry(htmlMatcher, this.authenticationEntryPoint));
			AuthenticationWebFilter authenticationFilter = new AuthenticationWebFilter(
				this.authenticationManager);
	...
	public final class LogoutSpec {
		...
		public ServerHttp2Security disable() {
			ServerHttp2Security.this.logout = null;
			return and();
		}
		...
		public void configure(ServerHttp2Security http) {
