...
/**
 * @see https://github.com/spring-projects/spring-data-commons/blob/master/src/main/java/org/springframework/data/repository/query/parser/Part.java
 * 
...
public class Part {
	 ...
	 */
	public Part(String source, boolean alwaysIgnoreCase) {
		...
		this.use = type.extractProperty(partToUse);
		this.columnName = StringUtil.camelConvert(this.use, "_");
		//this.columnName = CaseFormat.LOWER_CAMEL.to(CaseFormat.LOWER_UNDERSCORE,this.use);
	}
